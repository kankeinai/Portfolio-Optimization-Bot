...
with open(os.devnull, "w") as f, contextlib.redirect_stdout(f):
    ...
    julia.Julia(compiled_modules=False)  # Avoid using precompiled modules if there are issues
    ...
    # Include and execute the Julia script
...
def generate_histogram(data):
    ...
    # Customization for a beautiful plot
    ...
    plot_filename = generate_random_string(n = 10)+".png"  # Alternatively, use .pdf for higher quality
...
def generate_project_portfolio_report(folder, M,  budget, analysis=False, advanced=False, U=None, threshold=None, tolerance_level=None, max_violation=None):
    ...
    if found_files:
        ...
        """
                ...
                """
                counter_figure+=1
                latex_content += r"""With given solution, we managed to get expected profit of """ + str(round(expected_profit, 2)) + r"""\euro"""
                ...
                latex_content +=r""" Sorry, no feasible solution is found. Make sure that U is not too small."""
                if advanced:
...
if __name__ == "__main__":
    ...
    if os.path.exists(path):
        generate_project_portfolio_report(path, 1000,  1000, analysis=True)
